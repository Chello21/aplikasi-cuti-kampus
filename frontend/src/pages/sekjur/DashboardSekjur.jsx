    ...
    <div className="page-container fade-in">
      ...
      <div className="page-header">
        <div>
          ...
          <p className="page-subtitle">Verifikasi dan kelola data pengajuan cuti mahasiswa</p>
        </div>
      ...
      {selectedSurat && (
        <div className="modal-overlay print-modal-overlay" onClick={() => setSelectedSurat(null)}>
          <div className="modal-content print-modal-content" style={{ maxWidth: '750px', background: 'var(--bg-card)' }} onClick={e => e.stopPropagation()}>
            <div className="modal-header no-print">
              <h2>Template Surat Cuti</h2>
            ...
            <div className="modal-body" style={{ padding: '2.5rem 3.5rem', background: '#ffffff', color: '#000', borderRadius: '8px', margin: '1rem', border: '1px solid #ccc', fontFamily: '"Times New Roman", Times, serif', lineHeight: '1.4', textAlign: 'left' }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '15px', fontSize: '13px' }}>
                ...
                <div>Manado, {new Date(selectedSurat.created_at).toLocaleDateString('id-ID', { day: '2-digit', month: 'long' })} ........... 202...</div>
              </div>
              ...
              <div style={{ textAlign: 'center', fontSize: '13px' }}>
                ...
                <div style={{ height: '40px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                   {selectedSurat.status_kajur === 'Diterima' && (
                     <div style={{ border: '1px solid #2e7d32', color: '#2e7d32', padding: '2px 5px', fontWeight: 'bold', transform: 'rotate(-5deg)', fontSize: '11px' }}>
                       APPROVED SYSTEM
                     </div>
                   )}
                </div>
